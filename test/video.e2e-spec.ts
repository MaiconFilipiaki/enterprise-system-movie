...
describe('VideoController (e2e)', () => {
  ...
  beforeEach(async () => {
    jest
      .useFakeTimers({ advanceTimers: true })//vai precisar no controller, por causa da data no nome do arquivo
  ...
  afterAll(async () => {
    module.close();
    fs.rmSync('./uploads', { recursive: true, force: true }); // rm da pasta
  });
